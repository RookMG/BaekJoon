...
public class Main {
	...
	static final int MOD = 998244353, BASE = 3, SIZE = 2097152, END = 1048576;
	public static void main(String[] args) throws Exception {
		...
		arr = fft(arr,false);
		for(int i=0;i<SIZE;i++) arr[i] = arr[i]*arr[i]%MOD;
		arr = fft(arr,true);
		for(int i=Integer.parseInt(br.readLine());i>0;i--){
			int num = Integer.parseInt(br.readLine());
			sb.append(prime[num/2]?arr[num]/2+1:arr[num]/2).append("\n");
		}
